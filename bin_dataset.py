...
if __name__ == '__main__':
    ...
    """
    aps_path = r'"D:\桌面\Train\Train\aps_raw_int10\0000.bin"'
    evs_path = r'"D:\桌面\Train\Train\events\0000.bin"'
    ...
    evs_binned = binning_frame(torch.from_numpy(evs), out_frame=20)
